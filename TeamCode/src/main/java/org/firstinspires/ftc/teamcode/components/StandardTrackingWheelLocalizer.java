...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 3.3695; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = 3.401; // in; offset of the lateral wheel

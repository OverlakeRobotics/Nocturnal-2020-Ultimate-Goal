...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = Constants.LATERAL_DISTANCE; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = Constants.FORWARD_OFFSET; // in; offset of the lateral wheel
